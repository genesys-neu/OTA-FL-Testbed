...
class OFDM_Custom_Rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "OFDM_Custom_Rx")
        ...
        self.uhd_usrp_source_0 = uhd.usrp_source(
            ",".join(("addr=192.168.70.2", "", "master_clock_rate=200e6")),
            uhd.stream_args(
                cpu_format="fc32",
                args='',
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/ssp2943/Documents/OTA-FL-Demo/CSI-Use-Case/payload.bin', False)
        self.blocks_file_sink_0.set_unbuffered(True)
        self.blocks_complex_to_mag_0 = blocks.complex_to_mag(1)
        self.OTA_FL_filter_payload_py_0 = OTA_FL.filter_payload_py()
        self.OTA_FL_correlate_and_tag_py_0 = OTA_FL.correlate_and_tag_py(16456, (16456 + 500 + 38400 + 256), 1, "/home/ssp2943/Documents/gNB SDR/Suyash_OTA_FL/gr-OTA_FL/data/trainingSig",0, 0)
        ...
        self.connect((self.uhd_usrp_source_0, 0), (self.OTA_FL_correlate_and_tag_py_0, 0))
