...
class DMRS_OFDM(gr.top_block):
    ...
    def __init__(self):
        ...
        self.uhd_usrp_sink_0 = uhd.usrp_sink(
            ",".join(("addr=10.10.24.4", "", "master_clock_rate=200e6")),
            uhd.stream_args(
                cpu_format="fc32",
                args='',
        ...
        self.blocks_stream_mux_1 = blocks.stream_mux(gr.sizeof_gr_complex*1, (trainingSignal_size, 400, NFFT, 26624, 100))
        ...
        self.blocks_file_source_0_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/root/Suyash_OTA_FL/gr-OTA_FL/data/Weights_0.bin', True, 0, 0)
        ...
        self.OTA_FL_read_gold_seq_0 = OTA_FL.read_gold_seq("/root/Suyash_OTA_FL/gr-OTA_FL/data/trainingSig4", )
