...
class DMRS_OFDM(gr.top_block):
    ...
    def __init__(self):
        ...
        self.uhd_usrp_sink_0 = uhd.usrp_sink(
            ",".join(("addr=192.168.10.2 ,subdev=B:0", "", "master_clock_rate=200e6")),
            uhd.stream_args(
                cpu_format="fc32",
                args='',
                channels= [0],  # For Daughterboard B
            ),
            '',
        )
        self.uhd_usrp_sink_0.set_subdev_spec("B:0")  # For the first channel of Daughterboard B
        ...
        self.uhd_usrp_sink_0.set_bandwidth(3.84e6, 0)
        ...
        self.blocks_file_source_0_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/genesys/Demo/Suyash_OTA_FL/gr-OTA_FL/data/QPSK.bin', True, 0, 0)
