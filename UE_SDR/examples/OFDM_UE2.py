...
class DMRS_OFDM(gr.top_block):
    ...
    def __init__(self):
        ...
        self.samp_rate_0 = samp_rate_0 = 3840e3
        self.samp_rate = samp_rate = 3840e3
        ...
        self.uhd_usrp_sink_0 = uhd.usrp_sink(
            ",".join(("addr=192.168.10.2, subdev=A:0", "", "master_clock_rate=200e6")),
            uhd.stream_args(
                cpu_format="fc32",
                args='',
                channels=[0],
        ...
        self.uhd_usrp_sink_0.set_subdev_spec("A:0")  # For the first channel of Daughterboard B
        ...
        self.uhd_usrp_sink_0.set_gain(12, 0)
        ...
        self.blocks_stream_mux_1 = blocks.stream_mux(gr.sizeof_gr_complex*1, (trainingSignal_size, 400, NFFT, 38400, 100))
        ...
        self.blocks_file_source_0_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/genesys/Demo/Suyash_OTA_FL/gr-OTA_FL/data/Weights_1.bin', True, 0, 0)
        self.blocks_file_source_0_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/genesys/Demo/Suyash_OTA_FL/gr-OTA_FL/data/Pilots.bin', True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.OTA_FL_read_gold_seq_0 = OTA_FL.read_gold_seq("/home/genesys/Demo/Suyash_OTA_FL/gr-OTA_FL/data/trainingSig2", )
        self.OTA_FL_Precoder_0 = OTA_FL.Precoder('', 1, '224.3.28.70', 10000, 1)
        #self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/genesys/Demo/frame1.bin', False)
	...
	##################################################
        ...
        #self.connect((self.blocks_stream_mux_1, 0), (self.blocks_file_sink_0, 0))
