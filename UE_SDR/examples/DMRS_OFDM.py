...
class DMRS_OFDM(gr.top_block):
    ...
    def __init__(self):
        ...
        self.uhd_usrp_sink_0 = uhd.usrp_sink(
            ",".join(("addr=192.168.50.2, subdev=A:0", "", "master_clock_rate=200e6")),
            uhd.stream_args(
                cpu_format="fc32",
                args='',
                channels=[0],
        ...
        self.blocks_file_source_0_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/genesys/Demo/Suyash_OTA_FL/gr-OTA_FL/data/Weights_0.bin', True, 0, 0)
        self.blocks_file_source_0_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/genesys/Demo/Suyash_OTA_FL/gr-OTA_FL/data/Ones.bin', True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.OTA_FL_read_gold_seq_0 = OTA_FL.read_gold_seq("/home/genesys/Demo/Suyash_OTA_FL/gr-OTA_FL/data/trainingSig1", )
