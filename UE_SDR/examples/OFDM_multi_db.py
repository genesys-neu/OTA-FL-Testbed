...
class OFDM_multi_db(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Ofdm Multi Db", catch_exceptions=True)
        ...
        self.uhd_usrp_sink_0.set_center_freq(900e6, 1)
        self.uhd_usrp_sink_0.set_antenna('TX/RX', 1)
        self.uhd_usrp_sink_0.set_bandwidth(3840e3, 1)
        ...
        self.blocks_file_source_0_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/genesys/Demo/Suyash_OTA_FL/gr-OTA_FL/data/Rand.bin', True, 0, 0)
        ...
        self.OTA_FL_Precoder_0 = OTA_FL.Precoder('', 1, '224.3.28.70', 10000, 0)
...
def main(top_block_cls=OFDM_multi_db, options=None):
    tb = top_block_cls()
