...
class QPSK_OFDM_CP(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Qpsk Ofdm Cp", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Qpsk Ofdm Cp")
        ...
        self.settings = Qt.QSettings("GNU Radio", "QPSK_OFDM_CP")
        ...
        self.samp_rate_0 = samp_rate_0 = 480e3
        ...
        self.blocks_stream_mux_1 = blocks.stream_mux(gr.sizeof_gr_complex*1, (trainingSignal_size, 400, 256 * 103, 100))
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/otatestbed/Suyash_OTA_FL/gr-OTA_FL/data/Ones.bin', True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.OTA_FL_read_gold_seq_0 = OTA_FL.read_gold_seq("/home/otatestbed/Suyash_OTA_FL/gr-beamforming/examples/data/trainingSig1", )
        ...
        self.connect((self.blocks_repeat_0_0_0_1_0, 0), (self.blocks_stream_mux_1, 3))
...
def main(top_block_cls=QPSK_OFDM_CP, options=None):
